                ...
                function () {
                    if (0 !== $("#m_chart_trends_stats").length) {
                        ...
                        var a = {
                            type: "line",
                            data: {
                                labels: ["Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Janeiro", "Fevereiro", "Março", "Abril"],
                                datasets: [{
                                    label: "Acessos",
                                    backgroundColor: t,
                                    borderColor: "#0dc8de",
